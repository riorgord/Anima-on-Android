...
set OUT=D:\AI\anima_phone\anima_rt\vulkan

echo === Compiling shaders ===
REM The .comp sources are in D:\AI\anima_phone\vulkan\ — reuse them
set VKSRC=D:\AI\anima_phone\vulkan

REM GEMM BF16 weight + FP32 compute
"%VK_SDK%\Bin\glslangValidator.exe" -V "%VKSRC%\gemm_bf16.comp" -o "%OUT%\gemm_bf16.spv"
if %ERRORLEVEL% neq 0 echo ERROR: gemm_bf16 compile failed && exit /b 1
